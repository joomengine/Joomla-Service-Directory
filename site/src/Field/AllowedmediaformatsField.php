...
/**
 * Allowedmediaformats Form Field class for the Servicedirectory component
 *
 * @since  1.6
 */
class AllowedmediaformatsField extends ListField
{
	/**
	 * The allowedmediaformats field type.
	 *
	 * @var        string
	 */
	public $type = 'Allowedmediaformats';
	...
	protected function getOptions()
	{
		...
		$extensionList = MimeHelper::getFileExtensions('media', true);
