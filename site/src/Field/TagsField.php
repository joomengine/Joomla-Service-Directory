...
/**
 * Tags Form Field class for the Servicedirectory component
 *
 * @since  1.6
 */
class TagsField extends ListField
{
	...
	protected function getOptions()
	{
		...
		$query->select($db->quoteName(array('a.guid','a.name'),array('guid','tags_name')));
		...
		if ($items)
		{
			...
			{
				$options[] = Html::_('select.option', $item->guid, $item->tags_name);
			}
		}
		return $options;
	}
