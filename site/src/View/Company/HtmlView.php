 ...
 */
namespace JoomService\Component\Servicedirectory\Site\View\Company;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
		...
		$this->vvvsupport = $this->get('Vvvsupport');
	...
	protected function addToolbar(): void
	{
		...
		if (StringHelper::check($this->referral))
		{
			if ($this->canDo->get('core.create') && $isNew)
			{
				...
				ToolbarHelper::save('company.save', 'JTOOLBAR_SAVE');
			}
		...
		else
		{
			if ($isNew)
			{
				...
				{
					ToolbarHelper::apply('company.apply', 'JTOOLBAR_APPLY');
					ToolbarHelper::save('company.save', 'JTOOLBAR_SAVE');
					ToolbarHelper::custom('company.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
				};
				ToolbarHelper::cancel('company.cancel', 'JTOOLBAR_CANCEL');
			}
			else
			{
				...
				{
					ToolbarHelper::versions('com_servicedirectory.company', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
					ToolbarHelper::custom('company.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				ToolbarHelper::cancel('company.cancel', 'JTOOLBAR_CLOSE');
			}
		}
	...
	protected function _prepareDocument(): void
	{
		...
		$this->setDocumentTitle(Text::_($isNew ? 'COM_SERVICEDIRECTORY_COMPANY_NEW' : 'COM_SERVICEDIRECTORY_COMPANY_EDIT'));
		// add styles
...
/***[INSERTED$$$$]***//**398**/
		...
		Html::_('stylesheet', 'media/com_servicedirectory/uikit-v3/css/uikit.min.css', ['version' => 'auto']);/***[/INSERTED$$$$]***/
	}
