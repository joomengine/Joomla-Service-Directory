 ...
 */
namespace JoomService\Component\Servicedirectory\Site\View\Areaofexpertise;
...
/**
 * Servicedirectory Html View class for the Areaofexpertise
 *
 * @since  1.6
 */
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		$this->help_url = ServicedirectoryHelper::getHelpUrl('areaofexpertise');
