 ...
 */
namespace JoomService\Component\Servicedirectory\Site\View\Lang;
...
/**
 * Servicedirectory Html View class for the Lang
 *
 * @since  1.6
 */
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		$this->help_url = ServicedirectoryHelper::getHelpUrl('lang');
	...
	protected function _prepareDocument(): void
	{
		...
		if (isset($this->lang->metadesc) && $this->lang->metadesc)
		{
			$this->setDocumentTitle($this->lang->metadesc);
		}
		...
		if (isset($this->lang->metakey) && $this->lang->metakey)
		{
			$this->getDocument()->setMetadata('keywords', $this->lang->metakey);
		}
		...
		if (isset($this->lang->robots) && $this->lang->robots)
		{
			$this->getDocument()->setMetadata('robots', $this->lang->robots);
		}
		...
		if (isset($this->lang->created_by) && $this->params->get('MetaAuthor') == '1')
		{
			$this->getDocument()->setMetaData('author', $this->lang->created_by);
		}
		// check if metadata is available
		if (isset($this->lang->metadata) && $this->lang->metadata)
		{
			$mdata = json_decode($this->lang->metadata,true);
