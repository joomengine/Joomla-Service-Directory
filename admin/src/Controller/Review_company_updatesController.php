...
/**
 * Review_company_updates Admin Controller
 *
 * @since  1.6
 */
class Review_company_updatesController extends AdminController
{
	/**
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_SERVICEDIRECTORY_REVIEW_COMPANY_UPDATES';
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Review_company_update', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
