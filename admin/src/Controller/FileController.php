...
class FileController extends FormController
{
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_SERVICEDIRECTORY_FILE';
	...
	protected function allowAdd($data = [])
	{
		...
		// Access check.
		$access = $user->authorise('file.access', 'com_servicedirectory');
		if (!$access)
		{
			return false;
		}
		...
		return $user->authorise('file.create', $this->option);
	}
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_servicedirectory&view=files' . $this->getRedirectToListAppend(), false));
