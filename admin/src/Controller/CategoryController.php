...
class CategoryController extends FormController
{
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_SERVICEDIRECTORY_CATEGORY';
...
/***[INSERTED$$$$]***//**412**/
	...
	public function edit($key = null, $urlVar = null)
	{
		...
		{
			$value = GuidHelper::item($guid, 'category', 'a.' . $key, 'servicedirectory');
		}
	...
	protected function allowAdd($data = [])
	{
		...
		// Access check.
		$access = $user->authorise('category.access', 'com_servicedirectory');
		if (!$access)
		{
			return false;
		}
		...
		return $user->authorise('category.create', $this->option);
	}
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_servicedirectory&view=categories' . $this->getRedirectToListAppend(), false));
