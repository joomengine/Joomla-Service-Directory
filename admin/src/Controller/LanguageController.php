...
class LanguageController extends FormController
{
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_SERVICEDIRECTORY_LANGUAGE';
	...
	protected function allowAdd($data = [])
	{
		...
		// Access check.
		$access = $user->authorise('language.access', 'com_servicedirectory');
		if (!$access)
		{
			return false;
		}
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_servicedirectory&view=languages' . $this->getRedirectToListAppend(), false));
