...
class AddressController extends FormController
{
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_SERVICEDIRECTORY_ADDRESS';
	...
	public function edit($key = null, $urlVar = null)
	{
		...
		{
			$value = GuidHelper::item($guid, 'address', 'a.' . $key, 'servicedirectory');
		}
	...
	protected function allowAdd($data = [])
	{
		...
		// Access check.
		$access = $user->authorise('address.access', 'com_servicedirectory');
		if (!$access)
		{
			return false;
		}
		...
		return $user->authorise('address.create', $this->option);
	}
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_servicedirectory&view=addresses' . $this->getRedirectToListAppend(), false));
