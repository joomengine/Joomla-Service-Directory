...
class StateController extends FormController
{
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_SERVICEDIRECTORY_STATE';
	...
	public function edit($key = null, $urlVar = null)
	{
		...
		{
			$value = GuidHelper::item($guid, 'state', 'a.' . $key, 'servicedirectory');
		}
	...
	protected function allowAdd($data = [])
	{
		...
		// Access check.
		$access = $user->authorise('state.access', 'com_servicedirectory');
		if (!$access)
		{
			return false;
		}
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_servicedirectory&view=states' . $this->getRedirectToListAppend(), false));
