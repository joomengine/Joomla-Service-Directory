...
/**
 * Allowedimageformats Form Field class for the Servicedirectory component
 *
 * @since  1.6
 */
class AllowedimageformatsField extends ListField
{
	/**
	...
	protected function getOptions()
	{
		...
		$extensionList = MimeHelper::getFileExtensions('image', true);
