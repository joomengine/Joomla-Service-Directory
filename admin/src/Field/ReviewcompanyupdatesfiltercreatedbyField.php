...
/**
 * Reviewcompanyupdatesfiltercreatedby Form Field class for the Servicedirectory component
 *
 * @since  1.6
 */
class ReviewcompanyupdatesfiltercreatedbyField extends ListField
{
	/**
	 * The reviewcompanyupdatesfiltercreatedby field type.
	 *
	 * @var        string
	 */
	public $type = 'Reviewcompanyupdatesfiltercreatedby';
