...
/**
 * Tagsfilterpublished Form Field class for the Servicedirectory component
 *
 * @since  1.6
 */
class TagsfilterpublishedField extends ListField
{
	/**
	 * The tagsfilterpublished field type.
	 *
	 * @var        string
	 */
	public $type = 'Tagsfilterpublished';
	...
	protected function getOptions()
	{
		...
		{
			// get tagsmodel
			$_model = ServicedirectoryHelper::getModel('tags');
