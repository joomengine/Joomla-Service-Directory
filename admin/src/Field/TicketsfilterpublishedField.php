...
/**
 * Ticketsfilterpublished Form Field class for the Servicedirectory component
 *
 * @since  1.6
 */
class TicketsfilterpublishedField extends ListField
{
	/**
	 * The ticketsfilterpublished field type.
	 *
	 * @var        string
	 */
	public $type = 'Ticketsfilterpublished';
