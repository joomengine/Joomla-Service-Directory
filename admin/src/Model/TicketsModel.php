...
class TicketsModel extends ListModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_servicedirectory/assets/css/tickets.css'
 	];
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		if ($formSubmited)
		{
			$subject = $input->post->get('subject');
	...
	protected function checkInNow(): void
	{
		...
		if ($time)
		{
			...
			if ($db->getNumRows())
			{
				...
				// Check table.
				$query->update($db->quoteName('#__servicedirectory_ticket'))->set($fields)->where($conditions); 
