...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if (ArrayHelper::check($this->items))
		{
			...
			if ($this->canState)
			{
				ToolbarHelper::publishList('companies.publish');
				ToolbarHelper::unpublishList('companies.unpublish');
			...
			{
				ToolbarHelper::deleteList('', 'companies.delete', 'JTOOLBAR_EMPTY_TRASH');
			}
