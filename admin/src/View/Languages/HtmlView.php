 ...
 */
namespace JoomService\Component\Servicedirectory\Administrator\View\Languages;
...
/**
 * Servicedirectory Html View class for the Languages
 *
 * @since  1.6
 */
...
class HtmlView extends BaseHtmlView
{
	...
	{
		ToolbarHelper::title(Text::_('COM_SERVICEDIRECTORY_LANGUAGES'), 'health');
		/** @var  Toolbar $toolbar */
		...
		if (!$this->isEmptyState)
		{
			...
			if ($this->canEdit)
			{
				$childBar->edit('language.edit')->listCheck(true);
			}
		...
		$this->help_url = ServicedirectoryHelper::getHelpUrl('languages');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => Text::_('COM_SERVICEDIRECTORY_LANGUAGE_NAME_LABEL'),
			'a.langtag' => Text::_('COM_SERVICEDIRECTORY_LANGUAGE_LANGTAG_LABEL'),
