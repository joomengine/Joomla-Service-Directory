 ...
 */
namespace JoomService\Component\Servicedirectory\Administrator\View\Servicedirectory;
...
class HtmlView extends BaseHtmlView
{
	...
	function display($tpl = null): void
	{
		...
		$this->contributors   = ServicedirectoryHelper::getContributors();

		// get the manifest details of the component
		$this->manifest = ServicedirectoryHelper::manifest();
	...
	{
		$canDo = ServicedirectoryHelper::getActions('servicedirectory');
		ToolbarHelper::title(Text::_('COM_SERVICEDIRECTORY_DASHBOARD'), 'grid-2');

		// set help url for this view if found
		$this->help_url = ServicedirectoryHelper::getHelpUrl('servicedirectory');
	...
	{
		// set page title
		$this->getDocument()->setTitle(Text::_('COM_SERVICEDIRECTORY_DASHBOARD'));
