 ...
 */
namespace JoomService\Component\Servicedirectory\Administrator\View\Address_types;
...
/**
 * Servicedirectory Html View class for the Address_types
 *
 * @since  1.6
 */
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDelete = $this->canDo->get('address_type.delete');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => Text::_('COM_SERVICEDIRECTORY_ADDRESS_TYPE_NAME_LABEL'),
