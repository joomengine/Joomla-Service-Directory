 ...
 */
namespace JoomService\Component\Servicedirectory\Administrator\View\Categories;
...
/**
 * Servicedirectory Html View class for the Categories
 *
 * @since  1.6
 */
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canEdit = $this->canDo->get('category.edit');
		$this->canState = $this->canDo->get('category.edit.state');
		$this->canCreate = $this->canDo->get('category.create');
		$this->canDelete = $this->canDo->get('category.delete');
		$this->canBatch = ($this->canDo->get('category.batch') && $this->canDo->get('core.batch'));
	...
	{
		ToolbarHelper::title(Text::_('COM_SERVICEDIRECTORY_CATEGORIES'), 'wrench');
		...
		if (ArrayHelper::check($this->items))
		{
			...
			{
				ToolbarHelper::deleteList('', 'categories.delete', 'JTOOLBAR_EMPTY_TRASH');
			}
		...
		$this->help_url = ServicedirectoryHelper::getHelpUrl('categories');
