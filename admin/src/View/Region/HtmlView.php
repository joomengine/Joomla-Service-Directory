 ...
 */
namespace JoomService\Component\Servicedirectory\Administrator\View\Region;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = ServicedirectoryHelper::getActions('region', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title( Text::_($isNew ? 'COM_SERVICEDIRECTORY_REGION_NEW' : 'COM_SERVICEDIRECTORY_REGION_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			if ($isNew)
			{
				...
				if ($this->canDo->get('region.create'))
				{
					...
					ToolbarHelper::save('region.save', 'JTOOLBAR_SAVE');
					ToolbarHelper::custom('region.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
				};
				ToolbarHelper::cancel('region.cancel', 'JTOOLBAR_CANCEL');
			}
			else
			{
				...
				{
					ToolbarHelper::versions('com_servicedirectory.region', $this->item->id);
				}
				if ($this->canDo->get('region.create'))
				{
					ToolbarHelper::custom('region.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				ToolbarHelper::cancel('region.cancel', 'JTOOLBAR_CLOSE');
			}
		}
		...
		$this->help_url = ServicedirectoryHelper::getHelpUrl('region');
