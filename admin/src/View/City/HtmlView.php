 ...
 */
namespace JoomService\Component\Servicedirectory\Administrator\View\City;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = ServicedirectoryHelper::getActions('city', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title( Text::_($isNew ? 'COM_SERVICEDIRECTORY_CITY_NEW' : 'COM_SERVICEDIRECTORY_CITY_EDIT'), 'pencil-2 article-add');
		// Built the actions for new and existing records.
		if (StringHelper::check($this->referral))
		{
			if ($this->canDo->get('city.create') && $isNew)
			{
				// We can create the record.
				ToolbarHelper::save('city.save', 'JTOOLBAR_SAVE');
			}
			elseif ($this->canDo->get('city.edit'))
			{
		...
		else
		{
			if ($isNew)
			{
				...
				if ($this->canDo->get('city.create'))
				{
					ToolbarHelper::apply('city.apply', 'JTOOLBAR_APPLY');
					ToolbarHelper::save('city.save', 'JTOOLBAR_SAVE');
					ToolbarHelper::custom('city.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
				};
				ToolbarHelper::cancel('city.cancel', 'JTOOLBAR_CANCEL');
			}
			else
			{
				if ($this->canDo->get('city.edit'))
				{
				...
				$canVersion = ($this->canDo->get('core.version') && $this->canDo->get('city.version'));
				if ($this->state->params->get('save_history', 1) && $this->canDo->get('city.edit') && $canVersion)
				{
					ToolbarHelper::versions('com_servicedirectory.city', $this->item->id);
				}
				if ($this->canDo->get('city.create'))
				{
					ToolbarHelper::custom('city.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				ToolbarHelper::cancel('city.cancel', 'JTOOLBAR_CLOSE');
			}
		}
		...
		$this->help_url = ServicedirectoryHelper::getHelpUrl('city');
