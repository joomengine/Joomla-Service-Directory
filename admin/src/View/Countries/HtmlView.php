 ...
 */
namespace JoomService\Component\Servicedirectory\Administrator\View\Countries;
...
/**
 * Servicedirectory Html View class for the Countries
 *
 * @since  1.6
 */
...
class HtmlView extends BaseHtmlView
{
	...
	{
		ToolbarHelper::title(Text::_('COM_SERVICEDIRECTORY_COUNTRIES'), 'location');
		/** @var  Toolbar $toolbar */
		...
		if (!$this->isEmptyState)
		{
			...
			if ($this->canEdit)
			{
				$childBar->edit('country.edit')->listCheck(true);
			}
			...
			if ($this->canState)
			{
				...
				{
					$toolbar->delete('countries.delete', 'JTOOLBAR_DELETE_FROM_TRASH')
		...
		$this->help_url = ServicedirectoryHelper::getHelpUrl('countries');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => Text::_('COM_SERVICEDIRECTORY_COUNTRY_NAME_LABEL'),
			'g.name' => Text::_('COM_SERVICEDIRECTORY_COUNTRY_SUBREGION_LABEL'),
			'h.name' => Text::_('COM_SERVICEDIRECTORY_COUNTRY_CAPITAL_LABEL'),
			'a.currency_name' => Text::_('COM_SERVICEDIRECTORY_COUNTRY_CURRENCY_NAME_LABEL'),
