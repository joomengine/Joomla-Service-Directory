 ...
 */
namespace JoomService\Component\Servicedirectory\Administrator\View\Tags;
...
/**
 * Servicedirectory Html View class for the Tags
 *
 * @since  1.6
 */
...
class HtmlView extends BaseHtmlView
{
	...
	{
		ToolbarHelper::title(Text::_('COM_SERVICEDIRECTORY_TAGS'), 'tags-2');
		/** @var  Toolbar $toolbar */
		...
		if (!$this->isEmptyState)
		{
			...
			if ($this->canEdit)
			{
				$childBar->edit('tag.edit')->listCheck(true);
			}
		...
		$this->help_url = ServicedirectoryHelper::getHelpUrl('tags');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => Text::_('COM_SERVICEDIRECTORY_TAG_NAME_LABEL'),
			'g.name' => Text::_('COM_SERVICEDIRECTORY_TAG_PARENT_GUID_LABEL'),
