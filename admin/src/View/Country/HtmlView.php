 ...
 */
namespace JoomService\Component\Servicedirectory\Administrator\View\Country;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = ServicedirectoryHelper::getActions('country', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title( Text::_($isNew ? 'COM_SERVICEDIRECTORY_COUNTRY_NEW' : 'COM_SERVICEDIRECTORY_COUNTRY_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_servicedirectory.country', $this->item->id);
				}
				if ($this->canDo->get('country.create'))
				{
		...
		$this->help_url = ServicedirectoryHelper::getHelpUrl('country');
