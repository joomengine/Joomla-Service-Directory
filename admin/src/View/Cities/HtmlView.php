...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if (!$this->isEmptyState)
		{
			...
			if ($this->canEdit)
			{
				$childBar->edit('city.edit')->listCheck(true);
			}
			...
			if ($this->canState)
			{
				...
				{
					$childBar->checkin('cities.checkin')->listCheck(true);
				}

				if ($this->state->get('filter.published') == -2 && $this->canDelete)
				{
					$toolbar->delete('cities.delete', 'JTOOLBAR_DELETE_FROM_TRASH')
