 ...
 */
namespace JoomService\Component\Servicedirectory\Administrator\View\Tickets;
...
/**
 * Servicedirectory Html View class for the Tickets
 *
 * @since  1.6
 */
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDelete = $this->canDo->get('ticket.delete');
