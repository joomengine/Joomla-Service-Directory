...
<form action="<?php echo Route::_('index.php?option=com_servicedirectory&view=country&layout=' . $layout . $tmpl . '&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
...
<div class="main-card">
	...
	<?php echo Html::_('uitab.addTab', 'countryTab', 'details', Text::_('COM_SERVICEDIRECTORY_COUNTRY_DETAILS', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'countryTab', 'states', Text::_('COM_SERVICEDIRECTORY_COUNTRY_STATES', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
				<?php echo LayoutHelper::render('country.states_fullwidth', $this); ?>
			</div>
		</div>
	<?php echo Html::_('uitab.endTab'); ?>
	...
	<?php echo Html::_('uitab.addTab', 'countryTab', 'publishing', Text::_('COM_SERVICEDIRECTORY_COUNTRY_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'countryTab', 'permissions', Text::_('COM_SERVICEDIRECTORY_COUNTRY_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
				<fieldset id="fieldset-rules" class="options-form">
					<legend><?php echo Text::_('COM_SERVICEDIRECTORY_COUNTRY_PERMISSION'); ?></legend>
					<div>
