...
/** @var \JoomService\Component\Servicedirectory\Administrator\View\Language\HtmlView $this */

$icon = 'icon-check';
$title_key = $this->item->langtag ?? '';
$title_column = $this->item->name ?? '';
$data = [
	'contentType' => 'com_servicedirectory.language',
	'id' => $title_key,
	'title' => $title_column,
