...
<tr>
	...
	<?php endif; ?>
	<th class="nowrap" >
			<?php echo Html::_('searchtools.sort', 'COM_SERVICEDIRECTORY_TICKET_SUBJECT_LABEL', 'a.subject', $this->listDirn, $this->listOrder); ?>
	</th>
	<th class="nowrap" >
	...
	<th width="5" class="nowrap center hidden-phone" >
			<?php echo Html::_('searchtools.sort', 'COM_SERVICEDIRECTORY_TICKET_ID', 'a.id', $this->listDirn, $this->listOrder); ?>
	</th>
</tr>