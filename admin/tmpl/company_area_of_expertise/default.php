...
<form action="<?php echo Route::_('index.php?option=com_servicedirectory&view=company_area_of_expertise&layout=' . $layout . $tmpl . '&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
