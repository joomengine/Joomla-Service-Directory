...
/** @var \JoomService\Component\Servicedirectory\Administrator\View\Company_area_of_expertise\HtmlView $this */

$icon = 'icon-check';
$title_key = $this->item->id ?? '';
$title_column = $this->item->name ?? '';
$data = [
	'contentType' => 'com_servicedirectory.company_area_of_expertise',
	'id' => $title_key,
	'title' => $title_column,
