...
/** @var \JoomService\Component\Servicedirectory\Administrator\View\Review_company_update\HtmlView $this */

$icon = 'icon-check';
$title_key = $this->item->id ?? '';
$title_column = $this->item->name ?? '';
$data = [
	'contentType' => 'com_servicedirectory.review_company_update',
	'id' => $title_key,
	'title' => $title_column,
