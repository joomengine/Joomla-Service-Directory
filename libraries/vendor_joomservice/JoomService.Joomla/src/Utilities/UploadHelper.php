...
/***[JCBGUI.power.main_class_code.25.$$$$]***/
	...
	public static function get(string $field, string $type, string $filter = null, string $path = null): ?array
	{
		...
		{
			static::setError(Text::_('COM_SERVICEDIRECTORY_WARNING_UPLOAD_ERROR'));
		...
		{
			static::setError(Text::_('COM_SERVICEDIRECTORY_NO_UPLOAD_SELECTED'));
		...
		{
			static::setError(Text::_('COM_SERVICEDIRECTORY_THERE_WAS_AN_ERROR_UPLOADING_TO_THE_SERVER') . '<br>' . Text::_('COM_SERVICEDIRECTORY_THE_PHP_TEMPORARY_FOLDER_IS_NOT_SET'));
		...
		{
			static::setError(Text::_('COM_SERVICEDIRECTORY_THERE_WAS_AN_ERROR_UPLOADING_TO_THE_SERVER') . '<br>' . Text::_('COM_SERVICEDIRECTORY_YOUR_FILE_WAS_IS_LARGER_THAN_THE_ALLOWED_SIZE'));
		...
		{
			static::setError(Text::_('COM_SERVICEDIRECTORY_THERE_WAS_AN_ERROR_UPLOADING_TO_THE_SERVER'));
	...
	protected static function check(array $upload, string $type): ?array
	{
		...
		if (!in_array($extension, $legal_extensions))
		{
			...
			{
				static::setError(Text::_('COM_SERVICEDIRECTORY_UPLOAD_COULD_NOT_BE_REMOVED_WITH_THE_GIVEN_FULL_PATH'));
			}

			static::setError(Text::_('COM_SERVICEDIRECTORY_UPLOAD_IS_NOT_A_VALID_TYPE'));
