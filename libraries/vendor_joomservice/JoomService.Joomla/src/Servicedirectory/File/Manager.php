...
use JoomService\Joomla\Servicedirectory\File\Image;
...
/***[JCBGUI.power.main_class_code.835.$$$$]***/
	...
	public function upload(string $guid, string $entity, string $target): void
	{
		...
		{
			throw new \InvalidArgumentException(Text::sprintf('COM_SERVICEDIRECTORY_FILE_TYPE_NOT_VALID_IN_S_AREA', $target));
		}
		...
		{
			throw new \InvalidArgumentException(Text::sprintf('COM_SERVICEDIRECTORY_YOU_DO_NOT_HAVE_PERMISSIONS_TO_UPLOAD_S', $fileType['name']));
		}
